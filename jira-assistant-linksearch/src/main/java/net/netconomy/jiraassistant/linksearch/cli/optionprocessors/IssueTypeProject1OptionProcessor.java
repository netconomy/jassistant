...
public class IssueTypeProject1OptionProcessor extends IssueTypeOptionProcessor implements LinkSearchOptionProcessor {

    @Override
    protected ProjectSearchData getProjectSearchData(LinkSearchData linkSearchData) {
        return linkSearchData.getProject1Data();
    }

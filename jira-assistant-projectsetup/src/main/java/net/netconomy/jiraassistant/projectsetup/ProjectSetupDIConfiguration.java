...
import net.netconomy.jiraassistant.projectsetup.cli.ProjectSetupOptionFactoryService;

@Configuration
@Import(BaseDIConfiguration.class)
@ComponentScan(value = { "net.netconomy.jiraassistant.projectsetup" })
public class ProjectSetupDIConfiguration {

    @Bean
    public OptionFactory optionFactory() {
        return new ProjectSetupOptionFactoryService();
    }
